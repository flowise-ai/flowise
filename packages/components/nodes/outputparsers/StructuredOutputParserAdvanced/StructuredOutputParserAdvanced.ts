...

     {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                rows: 10,
                default: `z.object({
    t, // Title of the movie as a string
    yea., // Release year as an integer number,
    genres: z.enum([
        "Action", "Comedy", "Drama", "Fantasy", "Horror",
        "Mystery", "Romance", "Science Fiction", "Thriller", "Documentary"
    ]).a.max(2), // Array of genres, max of 2 from the defined enum
    .max(500) // Short description, max 500 characters
})`
            }
        ]
    }
